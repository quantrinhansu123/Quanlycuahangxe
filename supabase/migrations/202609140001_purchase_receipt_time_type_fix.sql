-- Migration: 202609140001_purchase_receipt_time_type_fix.sql
-- Description:
--   Fix save_purchase_receipt khi phieu_nhap_hang.gio la text nhung
--   nhap_xuat_kho.gio la time without time zone.
--   Giu chuoi gio tren header/JSON va parse mot lan sang TIME truoc khi ghi kho.
...
-- Preserve the hardened RPC access policy after CREATE OR REPLACE.
