      ...
      <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
         <div className="bg-card w-full max-w-3xl rounded-3xl shadow-2xl flex flex-col max-h-[92vh] overflow-hidden border border-border animate-in zoom-in-95 duration-300">
            ...
            <div className="px-3 py-3 sm:px-8 sm:py-5 border-t border-border bg-muted/10 flex flex-nowrap items-stretch gap-1.5 sm:gap-3 shrink-0 min-w-0">
                  ...
                  >
                     <Phone size={14} className="shrink-0 sm:hidden" /><Phone size={18} className="shrink-0 hidden sm:block" />
                  ...
                  <div className="relative flex-1 min-w-0">
                     <button 
                        ...
                        className="w-full min-w-0 px-2 py-2.5 sm:px-6 sm:py-3 bg-blue-500 hover:bg-blue-600 text-white text-[10px] sm:text-sm font-black rounded-xl sm:rounded-2xl flex items-center justify-center gap-1 sm:gap-1.5 transition-all active:scale-95 shadow-lg shadow-blue-500/20 text-center leading-tight"
                     >
                        <MessageSquare size={14} className="shrink-0 sm:hidden" /><MessageSquare size={18} className="shrink-0 hidden sm:block" />
                        <span className="truncate">GỬI ZALO</span>
                     </button>
                     {copySuccess && (
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1 bg-slate-800 text-white text-[10px] font-bold rounded-lg flex items-center gap-1.5 whitespace-nowrap animate-in fade-in slide-in-from-bottom-2 duration-300 z-10">
