                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          const mockPayroll: BangLuong = {
                            ...
                            doanh_so_muc_tieu: 0,
                            ngay_cong_thuc_te: kq.soNgayCongDung,
                            so_gio_tang_ca: kq.gioTangCaApDung,
                            tien_an: kq.tienAn,
                            luong_ngay_cong: kq.tienTheoCong,
                            luong_doanh_so: kq.hoaHong,
                            luong_lam_them: kq.luongTangCa,
                            phu_cap_chuyen_can: kq.phuCapChuyenCan,
                            phu_cap_xang_xe: kq.phuCapXangDienThoai,
                            phu_cap_tham_nien: kq.phuCapThamNien,
                            tong_phu_cap: kq.phuCapChuyenCan + kq.phuCapXangDienThoai + kq.phuCapThamNien,
                            thuong_khac: input.thuongKhac || 0,
                            bhxh: 0,
                            thue_tncn: 0,
